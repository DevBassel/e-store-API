...
class UpdateOrderDto extends (0, mapped_types_1.PartialType)(create_order_dto_1.CreateOrderDto) {
    static _OPENAPI_METADATA_FACTORY() {
        return { paymentStatus: { required: false, enum: require("../enums/payment-status.enum").PaymentStatus }, status: { required: false, enum: require("../enums/order-status.enum").OrderStatus } };
    }
}
