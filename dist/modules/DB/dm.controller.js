...
let DbController = class DbController {
    ...
    seedig(count) {
        if (process.env.NODE_ENV === 'dev') {
            ...
            throw new common_1.BadRequestException('valid in dev mode');
    }
    clear() {
        if (process.env.NODE_ENV === 'dev') {
...
], DbController.prototype, "seedig", null);
__decorate([
