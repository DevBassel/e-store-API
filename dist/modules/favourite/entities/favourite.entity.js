...
let Favourite = class Favourite {
    static _OPENAPI_METADATA_FACTORY() {
        return { id: { required: true, type: () => Number }, user: { required: true, type: () => require("../../user/entities/user.entity").User }, userId: { required: true, type: () => Number }, productId: { required: true, type: () => Number }, product: { required: true, type: () => require("../../products/entities/product.entity").Product }, createdAt: { required: true, type: () => Date } };
    }
};
